...
def fetch_user_todos(user_id):
    ...
    Returns:
        list: A list of TODO dictionaries for the user.
    """
...
def main():
    """
    Gather all TODOs from all employees and export to JSON in the required
    dictionary of lists of dictionaries format.
    """
    all_users_data = {}
